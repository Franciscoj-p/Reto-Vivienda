...
- **100% Configurable (`app/config.py`):** Todos los parámetros normativos (SMMLV 2026, topes VIS/VIP, matrices de subsidios, tasas de interés hipotecario, plazos y pesos de scoring) están centralizados en un único archivo de configuración editables sin alterar el código del motor.
